#!/usr/bin/env python3
"""
Quick Deployment Script for A2C Model
"""
...
class QuickDeploy:
    ...
    def check_api_keys(self):
        ...
        # Your 4 specific API keys
        keys = [
            'GROQ_API_KEY', 
            'WOLFRAM_ALPHA_APP_ID',  # Fixed: your actual variable name
            'GOOGLE_API_KEY', 
            'GOOGLE_CSE_ID'  # Added: your Google CSE ID
        ]
        missing = []
    ...
    def test_local_model(self):
        ...
        try:
            ...
            agent = A2CAgent(state_dim=state_dim, action_dim=state_dim, device=device)
            
            # Load trained model
            if os.path.exists('saved_model/a2c_actor.pth'):
    ...
    def deploy(self):
        ...
        if all_passed:
            ...
            print("2. Create .env file with your 4 API keys:")
            print("   GROQ_API_KEY=your_groq_key")
            print("   WOLFRAM_ALPHA_APP_ID=your_wolfram_id")
